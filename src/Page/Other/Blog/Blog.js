    ...
    return (
        <section className=' bg-orange-50 py-8  '>
            <div className='w-4/5 mx-auto border p-3 border-orange-300 bg-white hover:border-orange-700 '>
                ...
                <div className="lg:mx-auto  w-full max-w-3xl mb-12 ">
                    <p className="mx-auto text-base leading-relaxed text-gray-600">SQL databases are primarily called as Relational Databases (RDBMS); whereas NoSQL database are primarily called as non-relational or distributed database. </p>
                    <p className="mx-auto text-base leading-relaxed text-gray-600">SQL databases defines and manipulates data based structured query language (SQL). Seeing from a side this language is extremely powerful.
                        <br />
            ...
            <div className='w-4/5 my-6 mx-auto border p-3 border-orange-300 bg-white hover:border-orange-700 '>
                ...
                <div className="lg:mx-auto  w-full max-w-3xl mb-12 ">
                    ...
                    <br />
                    <p className="mx-auto text-base leading-relaxed text-gray-600">JSON web token (JWT) is particularly a useful technology. In terms of Single Sign-On (SSO), it means that a service provider can receive trustworthy information from the authentication server.
            ...
            <div className='w-4/5 my-6 mx-auto border p-3 border-orange-300 bg-white hover:border-orange-700 '>
                ...
                <div className="lg:mx-auto  w-full max-w-3xl mb-12 ">
                    <p className="mx-auto text-base leading-relaxed text-gray-600">NodeJS :
